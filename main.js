...
// monster(이름,체력,최대체력,공격력,  경험치,골드,위치(location),spon)
// var orc = new monster("니르바쉬", 300, 300, 5, 100, 100,0);
var monster_scarecrow_1 = new monster("허수아비 1 강함",500, 500, 0, 100, 100, 1002,0);
var monster_scarecrow_2 = new monster("허수아비2", 50, 50, 0, 100,  100, 1003,0);
var monster_scarecrow_3 = new monster("허수아3", 50, 50, 0, 100,  100, 1004,0);
var monster_scarecrow_4 = new monster("허수아비", 50, 50, 0, 100,  100, 1005,0);
var monster_rat_1 = new monster("쥐", 50, 50, 0, 100,  100, 1006,0);
var monster_rat_2 = new monster("쥐", 50, 50, 0, 100,  100, 1001,0);
var monsterArray = [
	new monster("허수아비 1 강함", 50,50, 0,  100,  100, 1002,0),
	new monster("허수아비1", 50, 50, 0, 100,  100, 1003,0),
	new monster("허수아3", 50, 50, 0, 100,  100, 1004,0),
	new monster("허수아비", 50, 50, 0, 100,  100, 1005,0) ,           
	new monster("쥐", 50, 50, 0, 100,  100, 1006,0),             
	new monster("쥐", 50, 50, 0, 100,  100, 1001,0)         
];
...
function intro(){
	if(intoro = true){
	tv("때는 바야흐로 황금의 물줄기가 끊긴 때")
	tv("다시금 황금의 시대로 돌아가기 위한 어리석은 자들의")
	tv("몸부림이 시작되었다.")
	tv("모험의 꿈을 품은 마법사가 여기 존재한다.")
	tv("그의 이름은 용감한 마법사 세르파!\n\n")
